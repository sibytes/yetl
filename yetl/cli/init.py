...
def _make_config_file(
    directory: str, filename: str, data: str, overwrite: bool = False
):
...
def init(
    ...
    _make_config_file(
        environment_path,
        _DBX_CONFIG_FILE,
        get_dbx_environment_config(config_folder),
        overwrite,
    )
    _make_config_file(
        environment_path,
        _LOCAL_CONFIG_FILE,
        get_local_environment_config(config_folder),
        overwrite,
    )
