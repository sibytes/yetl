...
def test_icontext(i_context_config):
    ...
    assert context.pipeline_repository.pipeline_root == i_context_config["pipeline_repo"]["pipeline_file"]["pipeline_root"]
    assert context.pipeline_repository.sql_root == i_context_config["pipeline_repo"]["pipeline_file"]["sql_root"]
